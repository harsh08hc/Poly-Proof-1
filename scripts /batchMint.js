...
async function main() {
  ...
  const networkAddress =
    "https://eth-goerli.g.alchemy.com/v2/s_2SlXa-nrqnTKcKIE6GMlwkCmifw7Hh";
  ...
  const contractAddress = "0x58fbb4B182d527AD3660E260d71Bd89E23f7dC5A";

  // Get the contract factory and attach it to the signer
  const IndianNFT = await ethers.getContractFactory("ronaldo", signer);
